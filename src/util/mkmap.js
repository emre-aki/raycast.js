...
const loadMap = function() {
  const file = path.join(ROOT, "scripts", "map.js");
...
const saveMap = function(mapData) {
  ...
  const mapTemplate = readFile(path.join(ROOT, "templates", "map.tjs"));
  writeFile(path.join(ROOT, "scripts", "map.js"), mapTemplate, {
